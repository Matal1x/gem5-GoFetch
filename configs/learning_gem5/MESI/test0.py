...
binaries = ["/import/lab/users/aslaoui/gem5-Okapi/tests/test-progs/threads/bin/x86/linux/test0" for i in range(num_cpus)]
# Setup workload binary path
thispath = os.path.dirname(os.path.realpath(__file__))
binary = os.path.join(
    thispath,
    "../../../",
    "tests/test-progs/threads/bin/x86/linux/test0",
)
